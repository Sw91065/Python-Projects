...
alter table bank_inventory modify geo_location varchar(20);
# Question 2:
...
update bank_inventory set estimated_sale_price =estimated_sale_price *.15 where quantity >4;
# Question 3:
...
insert into bank_inventory values ('DailCard',2,380.00,8500.87,9000.00*.1,NULL);
...
delete from bank_inventory where (estimated_sale_price - Purchase_cost)< estimated_sale_price*.05;
...
insert into bank_holidays values ('2020/03/20',current_date(),current_date());
